...
exports.generateDerivedKey = void 0;
var derived_key_1 = require("./derived-key");
/**
...
function generateDerivedKey(_a) {
    var key = _a.key, length = _a.length, minIterations = _a.minIterations, iterationVariance = _a.iterationVariance, useSalt = _a.useSalt;
    return __awaiter(this, void 0, void 0, function () {
        var derivedKeyOptions, derivedKey;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    derivedKeyOptions = derived_key_1.DerivedKeyOptions.randomFromOptions({
                        iterationVariance: iterationVariance,
                        length: length,
                        minIterations: minIterations,
                        strategy: derived_key_1.KeyDerivationStrategy.Pbkdf2Hmac,
                        useSalt: useSalt,
                    });
                    return [4 /*yield*/, derivedKeyOptions.deriveKey(key)];
                case 1:
                    derivedKey = _b.sent();
                    return [2 /*return*/, {
                            key: derivedKey,
