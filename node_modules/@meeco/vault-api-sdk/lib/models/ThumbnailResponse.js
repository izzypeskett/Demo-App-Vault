...
exports.ThumbnailResponseFromJSON = ThumbnailResponseFromJSON;
function ThumbnailResponseFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'thumbnail': _1.ThumbnailFromJSON(json['thumbnail']),
    };
}
exports.ThumbnailResponseFromJSONTyped = ThumbnailResponseFromJSONTyped;
function ThumbnailResponseToJSON(value) {
    ...
    return {
        'thumbnail': _1.ThumbnailToJSON(value.thumbnail),
    };
}
exports.ThumbnailResponseToJSON = ThumbnailResponseToJSON;
