...
exports.AssociationResponseFromJSON = AssociationResponseFromJSON;
function AssociationResponseFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'association': _1.AssociationFromJSON(json['association']),
    };
}
exports.AssociationResponseFromJSONTyped = AssociationResponseFromJSONTyped;
function AssociationResponseToJSON(value) {
    ...
    return {
        'association': _1.AssociationToJSON(value.association),
    };
}
exports.AssociationResponseToJSON = AssociationResponseToJSON;
