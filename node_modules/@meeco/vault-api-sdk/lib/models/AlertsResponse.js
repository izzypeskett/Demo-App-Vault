...
exports.AlertsResponseFromJSON = AlertsResponseFromJSON;
function AlertsResponseFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'alerts': _1.AlertsFromJSON(json['alerts']),
    };
}
exports.AlertsResponseFromJSONTyped = AlertsResponseFromJSONTyped;
function AlertsResponseToJSON(value) {
    ...
    return {
        'alerts': _1.AlertsToJSON(value.alerts),
    };
}
exports.AlertsResponseToJSON = AlertsResponseToJSON;
