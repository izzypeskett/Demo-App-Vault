...
exports.ListOrganizationMemberResponseFromJSON = ListOrganizationMemberResponseFromJSON;
function ListOrganizationMemberResponseFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'members': (json['members'].map(_1.OrganizationMemberFromJSON)),
        'organization': _1.OrganizationFromJSON(json['organization']),
        'meta': json['meta'],
        'next_page_after': json['next_page_after'],
    };
}
exports.ListOrganizationMemberResponseFromJSONTyped = ListOrganizationMemberResponseFromJSONTyped;
function ListOrganizationMemberResponseToJSON(value) {
    ...
    return {
        'members': (value.members.map(_1.OrganizationMemberToJSON)),
        'organization': _1.OrganizationToJSON(value.organization),
        'meta': value.meta,
        'next_page_after': value.next_page_after,
    };
}
exports.ListOrganizationMemberResponseToJSON = ListOrganizationMemberResponseToJSON;
