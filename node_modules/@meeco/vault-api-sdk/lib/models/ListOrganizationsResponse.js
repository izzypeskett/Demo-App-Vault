...
exports.ListOrganizationsResponseFromJSON = ListOrganizationsResponseFromJSON;
function ListOrganizationsResponseFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'services': (json['services'].map(_1.ServiceFromJSON)),
        'meta': json['meta'],
        'next_page_after': json['next_page_after'],
    };
}
exports.ListOrganizationsResponseFromJSONTyped = ListOrganizationsResponseFromJSONTyped;
function ListOrganizationsResponseToJSON(value) {
    ...
    return {
        'services': (value.services.map(_1.ServiceToJSON)),
        'meta': value.meta,
        'next_page_after': value.next_page_after,
    };
}
exports.ListOrganizationsResponseToJSON = ListOrganizationsResponseToJSON;
