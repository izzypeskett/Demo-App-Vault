...
exports.ListOrganizationsResponse2FromJSON = ListOrganizationsResponse2FromJSON;
function ListOrganizationsResponse2FromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'organizations': (json['organizations'].map(_1.OrganizationFromJSON)),
        'meta': json['meta'],
        'next_page_after': json['next_page_after'],
    };
}
exports.ListOrganizationsResponse2FromJSONTyped = ListOrganizationsResponse2FromJSONTyped;
function ListOrganizationsResponse2ToJSON(value) {
    ...
    return {
        'organizations': (value.organizations.map(_1.OrganizationToJSON)),
        'meta': value.meta,
        'next_page_after': value.next_page_after,
    };
}
exports.ListOrganizationsResponse2ToJSON = ListOrganizationsResponse2ToJSON;
