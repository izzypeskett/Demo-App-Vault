...
function InlineObjectFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'classification_node': !runtime_1.exists(json, 'classification_node') ? undefined : _1.ClassificationNodesClassificationNodeFromJSON(json['classification_node']),
    };
}
...
function InlineObjectToJSON(value) {
    ...
    return {
        'classification_node': _1.ClassificationNodesClassificationNodeToJSON(value.classification_node),
    };
}
