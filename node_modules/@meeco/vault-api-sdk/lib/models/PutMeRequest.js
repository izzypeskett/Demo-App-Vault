...
exports.PutMeRequestFromJSON = PutMeRequestFromJSON;
function PutMeRequestFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'user': !runtime_1.exists(json, 'user') ? undefined : _1.PutMeRequestUserFromJSON(json['user']),
    };
}
exports.PutMeRequestFromJSONTyped = PutMeRequestFromJSONTyped;
function PutMeRequestToJSON(value) {
    ...
    return {
        'user': _1.PutMeRequestUserToJSON(value.user),
    };
}
exports.PutMeRequestToJSON = PutMeRequestToJSON;
