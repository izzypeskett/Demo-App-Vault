...
function UpdateOrganizationRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'organization': !runtime_1.exists(json, 'organization') ? undefined : _1.OrganizationsIdOrganizationFromJSON(json['organization']),
    };
}
...
function UpdateOrganizationRequestToJSON(value) {
    ...
    return {
        'organization': _1.OrganizationsIdOrganizationToJSON(value.organization),
    };
}
