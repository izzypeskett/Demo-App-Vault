...
exports.AttachmentResponseFromJSON = AttachmentResponseFromJSON;
function AttachmentResponseFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'attachment': _1.AttachmentFromJSON(json['attachment']),
    };
}
exports.AttachmentResponseFromJSONTyped = AttachmentResponseFromJSONTyped;
function AttachmentResponseToJSON(value) {
    ...
    return {
        'attachment': _1.AttachmentToJSON(value.attachment),
    };
}
exports.AttachmentResponseToJSON = AttachmentResponseToJSON;
