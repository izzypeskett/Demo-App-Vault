...
exports.UpdateOrganizationServiceRequestFromJSON = UpdateOrganizationServiceRequestFromJSON;
function UpdateOrganizationServiceRequestFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'service': !runtime_1.exists(json, 'service') ? undefined : _1.OrganizationsOrganizationIdServicesIdServiceFromJSON(json['service']),
    };
}
exports.UpdateOrganizationServiceRequestFromJSONTyped = UpdateOrganizationServiceRequestFromJSONTyped;
function UpdateOrganizationServiceRequestToJSON(value) {
    ...
    return {
        'service': _1.OrganizationsOrganizationIdServicesIdServiceToJSON(value.service),
    };
}
exports.UpdateOrganizationServiceRequestToJSON = UpdateOrganizationServiceRequestToJSON;
