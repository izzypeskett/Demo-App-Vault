...
var ImageApi = /** @class */ (function (_super) {
     ...
     * Show Image
     */
    ImageApi.prototype.imagesIdGetRaw = function (requestParameters) {
     ...
     * Show Image
     */
    ImageApi.prototype.imagesIdGet = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.imagesIdGetRaw({ id: id })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     * Create Image
     */
    ImageApi.prototype.imagesPostRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        if (requestParameters.imageImageFile === null || requestParameters.imageImageFile === undefined) {
                            throw new runtime.RequiredError('imageImageFile', 'Required parameter requestParameters.imageImageFile was null or undefined when calling imagesPost.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (this.configuration && this.configuration.apiKey) {
     ...
     * Create Image
     */
    ImageApi.prototype.imagesPost = function (imageImageFile) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.imagesPostRaw({ imageImageFile: imageImageFile })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
