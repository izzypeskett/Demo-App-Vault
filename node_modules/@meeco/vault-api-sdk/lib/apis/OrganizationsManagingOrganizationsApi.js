 ...
 *
 */
var OrganizationsManagingOrganizationsApi = /** @class */ (function (_super) {
    __extends(OrganizationsManagingOrganizationsApi, _super);
    function OrganizationsManagingOrganizationsApi() {
     ...
     */
    OrganizationsManagingOrganizationsApi.prototype.organizationsIdDeleteRaw = function (requestParameters) {
     ...
     * Delete a requested organization
     */
    OrganizationsManagingOrganizationsApi.prototype.organizationsIdDelete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.organizationsIdDeleteRaw({ id: id })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    OrganizationsManagingOrganizationsApi.prototype.organizationsIdLoginPostRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.id === null || requestParameters.id === undefined) {
                            throw new runtime.RequiredError('id', 'Required parameter requestParameters.id was null or undefined when calling organizationsIdLoginPost.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (this.configuration && this.configuration.apiKey) {
     ...
     * Log in as organization agent
     */
    OrganizationsManagingOrganizationsApi.prototype.organizationsIdLoginPost = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.organizationsIdLoginPostRaw({ id: id })];
                    case 1:
                        response = _a.sent();
     ...
     */
    OrganizationsManagingOrganizationsApi.prototype.organizationsIdPutRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: models_1.UpdateOrganizationRequestToJSON(requestParameters.updateOrganizationParams),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.UpdateOrganizationResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Update a requested organization
     */
    OrganizationsManagingOrganizationsApi.prototype.organizationsIdPut = function (id, updateOrganizationParams) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.organizationsIdPutRaw({ id: id, updateOrganizationParams: updateOrganizationParams })];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    OrganizationsManagingOrganizationsApi.prototype.organizationsPostRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: models_1.PostOrganizationRequestToJSON(requestParameters.organizationParams),
                            })];
                    case 1:
                        response = _a.sent();
     ...
     * Create an organization
     */
    OrganizationsManagingOrganizationsApi.prototype.organizationsPost = function (organizationParams) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.organizationsPostRaw({ organizationParams: organizationParams })];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    return OrganizationsManagingOrganizationsApi;
}(runtime.BaseAPI));
exports.OrganizationsManagingOrganizationsApi = OrganizationsManagingOrganizationsApi;
