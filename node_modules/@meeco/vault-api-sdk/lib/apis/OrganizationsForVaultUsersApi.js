 ...
 *
 */
var OrganizationsForVaultUsersApi = /** @class */ (function (_super) {
    __extends(OrganizationsForVaultUsersApi, _super);
    function OrganizationsForVaultUsersApi() {
     ...
     * List organizations
     */
    OrganizationsForVaultUsersApi.prototype.organizationsGetRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.ListOrganizationsResponse1FromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * List organizations
     */
    OrganizationsForVaultUsersApi.prototype.organizationsGet = function (mode, nextPageAfter, perPage) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.organizationsGetRaw({ mode: mode, nextPageAfter: nextPageAfter, perPage: perPage })];
                    case 1:
                        response = _a.sent();
     ...
     */
    OrganizationsForVaultUsersApi.prototype.organizationsIdGetRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.GetOrganizationbyIdResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Retrieve a validated organization or a requested organization
     */
    OrganizationsForVaultUsersApi.prototype.organizationsIdGet = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.organizationsIdGetRaw({ id: id })];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    OrganizationsForVaultUsersApi.prototype.organizationsOrganizationIdServicesIdGetRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.organizationId === null || requestParameters.organizationId === undefined) {
                            throw new runtime.RequiredError('organizationId', 'Required parameter requestParameters.organizationId was null or undefined when calling organizationsOrganizationIdServicesIdGet.');
                        }
                        if (requestParameters.id === null || requestParameters.id === undefined) {
                            throw new runtime.RequiredError('id', 'Required parameter requestParameters.id was null or undefined when calling organizationsOrganizationIdServicesIdGet.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (this.configuration && this.configuration.apiKey) {
     ...
     * Retrieve a validated organization service
     */
    OrganizationsForVaultUsersApi.prototype.organizationsOrganizationIdServicesIdGet = function (organizationId, id) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.organizationsOrganizationIdServicesIdGetRaw({ organizationId: organizationId, id: id })];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
    ...
    return OrganizationsForVaultUsersApi;
}(runtime.BaseAPI));
exports.OrganizationsForVaultUsersApi = OrganizationsForVaultUsersApi;
