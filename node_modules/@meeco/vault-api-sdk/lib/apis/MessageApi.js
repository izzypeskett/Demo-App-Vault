...
var MessageApi = /** @class */ (function (_super) {
     ...
     * List Messages
     */
    MessageApi.prototype.dashboardMessagesGetRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.GetMessagesResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * List Messages
     */
    MessageApi.prototype.dashboardMessagesGet = function (page, per) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dashboardMessagesGetRaw({ page: page, per: per })];
                    case 1:
                        response = _a.sent();
     ...
     * Delete a Message
     */
    MessageApi.prototype.dashboardMessagesIdDeleteRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.id === null || requestParameters.id === undefined) {
                            throw new runtime.RequiredError('id', 'Required parameter requestParameters.id was null or undefined when calling dashboardMessagesIdDelete.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (this.configuration && this.configuration.apiKey) {
     ...
     * Delete a Message
     */
    MessageApi.prototype.dashboardMessagesIdDelete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dashboardMessagesIdDeleteRaw({ id: id })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
