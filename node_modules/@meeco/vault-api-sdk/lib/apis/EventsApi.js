...
var EventsApi = /** @class */ (function (_super) {
     ...
     * Get Events
     */
    EventsApi.prototype.eventsGetRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.EventsResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get Events
     */
    EventsApi.prototype.eventsGet = function (nextPageAfter, perPage, eventType, onDate) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.eventsGetRaw({ nextPageAfter: nextPageAfter, perPage: perPage, eventType: eventType, onDate: onDate })];
                    case 1:
                        response = _a.sent();
     ...
     * Get Event
     */
    EventsApi.prototype.eventsIdGetRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.EventResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get Event
     */
    EventsApi.prototype.eventsIdGet = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.eventsIdGetRaw({ id: id })];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Create Event
     */
    EventsApi.prototype.eventsPostRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.eventParams === null || requestParameters.eventParams === undefined) {
                            throw new runtime.RequiredError('eventParams', 'Required parameter requestParameters.eventParams was null or undefined when calling eventsPost.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: models_1.PostEventsRequestToJSON(requestParameters.eventParams),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.EventResponseFromJSON(jsonValue); })];
     ...
     * Create Event
     */
    EventsApi.prototype.eventsPost = function (eventParams) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.eventsPostRaw({ eventParams: eventParams })];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
