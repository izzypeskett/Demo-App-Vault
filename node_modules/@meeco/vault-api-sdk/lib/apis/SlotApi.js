 ...
 *
 */
var SlotApi = /** @class */ (function (_super) {
    __extends(SlotApi, _super);
    function SlotApi() {
     ...
     * Delete a Slot
     */
    SlotApi.prototype.slotsIdDeleteRaw = function (requestParameters) {
     ...
     * Delete a Slot
     */
    SlotApi.prototype.slotsIdDelete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.slotsIdDeleteRaw({ id: id })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     * Get a Slot
     */
    SlotApi.prototype.slotsIdGetRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.SlotResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get a Slot
     */
    SlotApi.prototype.slotsIdGet = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.slotsIdGetRaw({ id: id })];
                    case 1:
                        response = _a.sent();
     ...
     * Update a Slot
     */
    SlotApi.prototype.slotsIdPutRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.id === null || requestParameters.id === undefined) {
                            throw new runtime.RequiredError('id', 'Required parameter requestParameters.id was null or undefined when calling slotsIdPut.');
                        }
                        if (requestParameters.updateSlotParams === null || requestParameters.updateSlotParams === undefined) {
                            throw new runtime.RequiredError('updateSlotParams', 'Required parameter requestParameters.updateSlotParams was null or undefined when calling slotsIdPut.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: models_1.PutSlotsRequestToJSON(requestParameters.updateSlotParams),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.SlotResponseFromJSON(jsonValue); })];
     ...
     * Update a Slot
     */
    SlotApi.prototype.slotsIdPut = function (id, updateSlotParams) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.slotsIdPutRaw({ id: id, updateSlotParams: updateSlotParams })];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
