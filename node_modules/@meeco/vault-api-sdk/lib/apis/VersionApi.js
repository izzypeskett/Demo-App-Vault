...
var VersionApi = /** @class */ (function (_super) {
     ...
     * Returns the API version and the component name
     */
    VersionApi.prototype.versionGetRaw = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.VersionResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Returns the API version and the component name
     */
    VersionApi.prototype.versionGet = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.versionGetRaw()];
                    case 1:
                        response = _a.sent();
