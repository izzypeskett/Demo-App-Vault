...
var AdmissionTokenApi = /** @class */ (function (_super) {
     ...
     */
    AdmissionTokenApi.prototype.admissionTokensPostRaw = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return models_1.AdmissionTokenResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Creates an admission token
     */
    AdmissionTokenApi.prototype.admissionTokensPost = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.admissionTokensPostRaw()];
                    case 1:
                        response = _a.sent();
     ...
     */
    AdmissionTokenApi.prototype.admissionTokensTokenValueGetRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (requestParameters.tokenValue === null || requestParameters.tokenValue === undefined) {
                            throw new runtime.RequiredError('tokenValue', 'Required parameter requestParameters.tokenValue was null or undefined when calling admissionTokensTokenValueGet.');
                        }
                        queryParameters = {};
                        headerParameters = {};
                        if (this.configuration && this.configuration.apiKey) {
     ...
     * Returns an admission token
     */
    AdmissionTokenApi.prototype.admissionTokensTokenValueGet = function (tokenValue) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.admissionTokensTokenValueGetRaw({ tokenValue: tokenValue })];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
