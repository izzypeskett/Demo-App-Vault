...
import { client } from 'jsrp';
import * as Keystore from '@meeco/keystore-api-sdk';
import { BaseAPI } from '@meeco/keystore-api-sdk';
...
var debugCurl = debug('meeco:http');
...
var callApiWithHeaders = function callApiWithHeaders(sdk, api, apiMethodName, apiKey, basePath, headers, args) {
  var apiInstance = new sdk[api](new Configuration({
    apiKey: apiKey,
    basePath: basePath,
    middleware: [],
  ...
  if (apiInstance.constructor.__proto__ === BaseAPI) {
...
var ClientTaskQueueService = /*#__PURE__*/function () {
  ...
  _createClass(ClientTaskQueueService, [{
    ...
    value: function list(vaultAccessToken) {
      ...
      var state = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : State.Todo;
    ...
    value: function countOutstandingTasks(vaultAccessToken) {
      try {
        ...
        return _await$1(_this2.vaultAPIFactory(vaultAccessToken).ClientTaskQueueApi.clientTaskQueueGet(undefined, undefined, true, State.Todo), function (todoTasks) {
          return _await$1(_this2.vaultAPIFactory(vaultAccessToken).ClientTaskQueueApi.clientTaskQueueGet(undefined, undefined, true, State.InProgress), function (inProgressTasks) {
            return {
  ...
  _createClass(ItemService, [{
    ...
    value: function generateAndUploadThumbnail(file, binaryId, auth) {
      try {
        ...
        return _await$4(read(file), function (jimp) {
          return _await$4(jimp.resize(targetThumbnailSize, targetThumbnailSize).getBufferAsync(MIME_PNG), function (thumbnail) {
...
export { AuthData, ClientTaskQueueService, ConnectionCreateData, ConnectionService, ERROR_CODES, EncryptionKey, Environment, FileAttachmentData, ItemCreateData, ItemService, ItemUpdateData, MeecoServiceError, OrganizationServicesService, OrganizationsService, SRPSession, SecretService, ShareService, State, TemplatesService, UserService, _cryppoService, configureFetch, fetchConnectionWithId, findConnectionBetween, keystoreAPIFactory, vaultAPIFactory };
